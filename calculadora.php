                            ...
                            if(isset($_POST["calcular"])){  
                                ...
                                switch($operacion){
                                    case "sumar":
                                        ...
                                        echo("la suma es ".$numero1." + ".$numero2." = ".$resultado);
                                    break;

                                    case "restar":
                                            $resultado = $numero1 - $numero2;
                                            echo("la resta es ".$numero1." - ".$numero2." = ".$resultado);
                                    break;

                                    case "multiplicar":
                                        $resultado = $numero1 * $numero2;
                                        echo("la multiplicacion es ".$numero1." * ".$numero2." = ".$resultado);
                                    break;
                                    
                                    case "dividir":
                                        $resultado = $numero1 / $numero2;
                                        echo("la division es ".$numero1." / ".$numero2." = ".$resultado);
                                    break;
                                }
