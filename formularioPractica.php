        ...
        <main>
            <div class="container mt-5">
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <form action="formularioPractica.php" method="POST">
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-md-3">
                                ...
                                <div class="row justify-content-center mt-3">
                                        <div class="col-md-6">
                                            <button type="submit" class="btn btn-primary mb-2" name="enviarDatos">Enviar Datos</button>
                                        </div>
                                </div>
                ...
                <?php if(isset($_POST["enviarDatos"])): ?>
                            ...
                            <div class="row justify-content-center mt-5">
                                <div class="col-md-4 mt-2 mb-3">
                                    ...
                                    <h4 class="text-success">Nombre :<?php echo($nombre)?></h4>
                                    <h4 class="text-primary">Apellido :<?php echo($apellido)?></h4>
                                    <h4 class="text-danger">Edad :<?php echo($edad)?></h4>
                                </div>
                            </div>
                            ...
                            <?php if($sexo=="masculino"): ?>
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <img src="<?php echo($fotoHombre)?>" alt="Foto Hombre" class="w-100 img-fluid mb-5">
                                    </div>
                                 </div>
                            ...
                            <?php else: ?>
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <img src="<?php echo($fotoMujer)?>" alt="Foto Mujer" class="w-100 img-fluid mb-5">
                                    </div>
                                 </div>
